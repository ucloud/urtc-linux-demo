...
const int URTC_EVENT_MSG_SEND_MSG_ACK = URTC_EVENT_MSG_BASE + 30;
const int URTC_EVENT_MSG_USER_MSG_NOTIFY = URTC_EVENT_MSG_BASE + 31;
const int URTC_EVENT_MSG_UPNETWORK_STATE = URTC_EVENT_MSG_BASE + 32;
